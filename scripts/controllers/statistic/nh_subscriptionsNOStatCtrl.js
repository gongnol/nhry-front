(function() {
    ...
    angular
        .module('newhope')
        .controller('SubscriptionsNOStatCtrl', SubscriptionsNOStatCtrl);

    SubscriptionsNOStatCtrl.$inject = ['$scope', '$state', '$uibModal', 'restService'];

    function SubscriptionsNOStatCtrl($scope, $state, $uibModal, rest) {

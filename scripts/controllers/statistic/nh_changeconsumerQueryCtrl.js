(function() {
    ...
    angular
        .module('newhope')
        .controller('ChangeconsumerQueryCtrl', ChangeconsumerQueryCtrl);

    ChangeconsumerQueryCtrl.$inject = ['$scope', '$state', '$uibModal', 'restService'];

    function ChangeconsumerQueryCtrl($scope, $state, $uibModal, rest) {

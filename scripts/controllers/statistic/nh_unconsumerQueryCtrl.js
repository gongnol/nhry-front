(function() {
    ...
    angular
        .module('newhope')
        .controller('UnconsumerQueryCtrl', UnconsumerQueryCtrl);

    UnconsumerQueryCtrl.$inject = ['$scope', '$state', '$uibModal', 'restService'];

    function UnconsumerQueryCtrl($scope, $state, $uibModal, rest) {

(function() {
    ...
    angular
        .module('newhope')
        .controller('DoconsumerQueryCtrl', DoconsumerQueryCtrl);

    DoconsumerQueryCtrl.$inject = ['$scope', '$state', '$uibModal', 'restService'];

    function DoconsumerQueryCtrl($scope, $state, $uibModal, rest) {

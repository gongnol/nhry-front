(function() {
    ...
    angular
        .module('newhope')
        .controller('ConsumerQueryCtrl', ConsumerQueryCtrl);

    ConsumerQueryCtrl.$inject = ['$scope', '$state', '$uibModal', 'restService'];

    function ConsumerQueryCtrl($scope, $state, $uibModal, rest) {

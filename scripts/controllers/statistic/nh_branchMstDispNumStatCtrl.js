(function() {
    ...
    angular
        .module('newhope')
        .controller('BranchMstDispNumStatCtrl', BranchMstDispNumStatCtrl);

    BranchMstDispNumStatCtrl.$inject = ['$rootScope', '$scope', '$state', '$alert', '$uibModal', 'restService'];

    function BranchMstDispNumStatCtrl($rootScope, $scope, $state, $alert, $uibModal, rest) {
        ...
        vm.getData = function(pageno) {
            ...
            rest.branchMstDispNumStat(params).then(function(json) {
                vm.tbLoding = 0;

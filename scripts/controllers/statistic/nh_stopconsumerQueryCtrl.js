(function() {
    ...
    angular
        .module('newhope')
        .controller('StopconsumerQueryCtrl', StopconsumerQueryCtrl);

    StopconsumerQueryCtrl.$inject = ['$scope', '$state', '$uibModal', 'restService'];

    function StopconsumerQueryCtrl($scope, $state, $uibModal, rest) {

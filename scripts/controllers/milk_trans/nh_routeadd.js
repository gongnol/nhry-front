(function() {
	...
	angular
	  .module('newhope')
	  .controller('routeAddCtrl', routeAddCtrl)
      .controller('routeAddSubCtrl', routeAddSubCtrl);

	routeAddCtrl.$inject = ['$state', '$scope', '$uibModal', 'tableService'];

	function routeAddCtrl($state, $scope, $uibModal, tableService) {
    ...
    routeAddSubCtrl.$inject = ['$state', '$scope', 'tableService'];

    function routeAddSubCtrl($state, $scope, tableService) {

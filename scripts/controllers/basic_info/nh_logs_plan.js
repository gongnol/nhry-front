(function() {
    ...
    angular
        .module('newhope')
        .controller('PlanLogsCtrl', PlanLogsCtrl);

    PlanLogsCtrl.$inject = ['$scope', '$alert', '$rootScope', '$state', '$uibModal', 'restService', 'nhCommonUtil'];

    function PlanLogsCtrl($scope, $alert, $rootScope, $state, $uibModal, rest, nhCommonUtil) {
        var vm = this;
        ...
        vm.getData = function(pageno){
            ...
            rest.getPlanOperationLog(vm.tbParams).then(function (json) {
                vm.tbLoding = 0;

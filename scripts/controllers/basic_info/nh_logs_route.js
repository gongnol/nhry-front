(function() {
    ...
    angular
        .module('newhope')
        .controller('RouteLogsCtrl', RouteLogsCtrl);

    RouteLogsCtrl.$inject = ['$scope', '$alert', '$rootScope', '$state', '$uibModal', 'restService', 'nhCommonUtil'];

    function RouteLogsCtrl($scope, $alert, $rootScope, $state, $uibModal, rest, nhCommonUtil) {
        var vm = this;
        ...
        vm.getData = function(pageno){
            ...
            vm.tbParams = {
                ...
                dispDate: vm.search.dispDate,
                pageNum: pageno,
                pageSize: vm.itemsPerPage
            };
            
            rest.getRouteOperationLog(vm.tbParams).then(function (json) {
                vm.tbLoding = 0;
